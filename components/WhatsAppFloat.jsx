...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-[#25D366] px-4 py-3 shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:bg-[#20c25e] group"
