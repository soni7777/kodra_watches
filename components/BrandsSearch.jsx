        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
          {filtered.map(({ brand, coverUrl, count }) => (
            <Link
              ...
              className="group block overflow-hidden rounded-2xl border border-[var(--border)] bg-background-card transition-all duration-300 hover:border-gold/50 hover:shadow-[0_0_30px_rgba(201,168,106,0.12)] hover:-translate-y-1"
            >
              ...
              <div className="border-t border-[var(--border)] px-3 py-2.5">
                <h3 className="font-serif text-sm tracking-wide text-gold-light transition-colors duration-300 group-hover:text-gold sm:text-base">
                  {brand.name} Catalog
                </h3>
              </div>
            </Link>
